...
namespace SQL_to_c_
{
    ...
    class Program
    {
        ...
        public static void addclass()
        {
            string coursename;
            int ID, teachersID;
            Console.WriteLine("enter the name of the new class");
            coursename = Console.ReadLine();
            Console.WriteLine("enter the ID of the class");
            ID = int.Parse(Console.ReadLine());
            Console.WriteLine("enter the ID of the teacher who is teaching this class");
            teachersID = int.Parse(Console.ReadLine());
            SQLiteCommand sql = new SQLiteCommand("insert into classes(ID,coursename,teachersID) values ("+ID+", '"+coursename+"', "+teachersID+")",conn);
            sql.ExecuteNonQuery();
            Console.WriteLine();
            Console.WriteLine("new class " + coursename + " has been added");
            Console.WriteLine("press enter to return to menu");
            Console.ReadKey();
        }
        ...
        public static void deleteclass()
        {
            ...
            Console.WriteLine("enter the name of the class that you want to delete");
            string classname = Console.ReadLine();
            //Firstly the id of the class will need to be retieved(SQL required for this)
            SQLiteCommand sql = new SQLiteCommand("select ID from classes where coursename = " + classname, conn);
            SQLiteDataReader ID = sql.ExecuteReader();
            while (ID.Read())
            {
                Console.WriteLine(ID["ID"] + " " + ID["coursename"]);
            }
        ...
        {
            SQLiteDataReader rsclasses;
            Console.WriteLine("List of all classes");
            Console.WriteLine();
            SQLiteCommand sql = new SQLiteCommand("select * from classes order by ID", conn);
            rsclasses = sql.ExecuteReader();
            Console.WriteLine();
            while (rsclasses.Read())
            {
                Console.WriteLine(rsclasses["ID"] + " " + rsclasses["coursename"]);
            }
